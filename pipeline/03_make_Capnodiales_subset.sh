#!/usr/bin/bash -l
#SBATCH -p short -c 24 --mem 24gb --out logs/make_Capnodiales_tree.log
CPU=2
...
mkdir -p $OUTDIR
# make a file from UNITE of all Capnodiales
...
# make a file from Vargas et al 2024 UHM ITS1 of all Capnodiales
